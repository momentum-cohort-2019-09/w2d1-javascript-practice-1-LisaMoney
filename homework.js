...
function fahrenheitToCelsius(fTemperature) {
...
function fahrenheitToKelvin (fTemperature) {
    return (fTemperature - 32) * 5 / 9 + 273.15
}
...
function lesser (number, integer) {
if (number >= integer) {
    return integer
} else {
    return number
...
/* function gcd (number, integer) {
    while (number % 2 === 0) && (integer % 2 === 0) {
